...
const styles = StyleSheet.create({
  ...
  cameraLeftToolbar: { position: "absolute", left: 12, top: "20%", gap: 10 },
  cameraToolItem: { alignItems: "center", gap: 2 },
  cameraToolIconWrap: { width: 38, height: 38, borderRadius: 19, backgroundColor: "rgba(0,0,0,0.45)", alignItems: "center", justifyContent: "center" },
  cameraToolLabel: { color: "#fff", fontSize: 9.5, fontWeight: "600" },
